...
We use the dataset containing quaterly bilateral exchange rate between EU and SEK.


```{r}
dat = read.table(file = "ert_bil_eur_q.tsv", sep = '\t', header = TRUE)
kable(dat[65:70, 1:5], caption = "Quaterly bilateral exchange rate", digits = 2)
```
